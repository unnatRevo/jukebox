...
session_start();
  ...
  // If user is not loggedin and try to go back then redirect to index.php
  if ( (!(isset($_SESSION['username']))
  ...
  <head>
    ...
    <script language="javascript" type="text/javascript">
      function fileUploadPopup(url) {
      	newwindow=window.open(url,'File_Upload_Popup','height=500,width=800');
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../Welcome.php" class="logo">
          ...
          <span class="logo-lg"><b>Juke</b>box</span>
        </a>
              ...
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <button class='btn btn-primary pull-right'
                    href="PopupFileUpload.php" onclick="return fileUploadPopup('PopupFileUpload.php')">
                    Upload Files</button>
                </h1>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div id="dialog-form" title="Create new user">
                        <p class="validateTips">File is require.</p>

                        <form>
                          <fieldset>
                            <label for="file">File</label>
                            <input type="file" name="fileUpload" id="fileUpload" class="text ui-widget-content ui-corner-all">
